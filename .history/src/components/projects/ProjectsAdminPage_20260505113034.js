...
export default function ProjectsAdminPage({ items, categories }) {
  ...
  const shouldOpenCategories = searchParams.get("manageCategories") === "1";
  const isCategoryModalVisible = isCategoryModalOpen || shouldOpenCategories;
  ...
  const closeCategoryModal = () => {
    ...
    nextParams.delete("manageCategories");
          ...
          <CardHeader className="border-b border-border-subtle bg-surface-main/80">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
              <div>
                ...
                <CardDescription>Search, filter, and edit projects.</CardDescription>
              </div>
