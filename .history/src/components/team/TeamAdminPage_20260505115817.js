    ...
    <>
      <div className="space-y-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <h1 className="font-display text-3xl font-semibold text-accent-deep-blue">Our Team</h1>
            <p className="mt-2 max-w-3xl text-sm text-text-secondary">
              Manage team profiles, profile photos, qualifications, and biographies from one focused workspace.
            </p>
          </div>
