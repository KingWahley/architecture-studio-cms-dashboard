      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <Button type="button" variant="secondary" onClick={() => fileInputRef.current?.click()} className="gap-2">
            <Upload size={16} />
            {queue.length > 0 ? "Add More" : "Choose Files"}
          </Button>
          {queue.length > 0 ? (
            <Button type="button" onClick={handleUploadQueue} disabled={isUploading} className="gap-2">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                <div>
                  ...
                  <CardDescription>
                    Select multiple images to apply bulk action.
                  </CardDescription>
                </div>
                          ...
                          {hasImage ? (
                            ...
                            <div className="flex aspect-square items-center justify-center text-text-secondary">
                              <div className="text-center">
                                ...
                                <p className="mt-3 text-xs">No preview available</p>
                              </div>
                            </div>
                          )}
                        </div>
