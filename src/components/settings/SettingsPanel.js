        ...
        <Card className="border-accent-deep-blue/10">
          ...
          <CardContent>
            <form className="space-y-4" onSubmit={handlePasswordSubmit}>
              ...
              <div className="rounded-2xl border border-border-subtle bg-surface-alt/75 p-4 text-sm leading-6 text-text-secondary">
                The password change is fully interactive in the UI and persists on this device using secure browser storage.
              </div>
